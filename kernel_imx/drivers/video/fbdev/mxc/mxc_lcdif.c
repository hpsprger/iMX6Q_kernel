...
static struct fb_videomode lcdif_modedb[] = {
	...
	0,},
	{
        "TQ-TFT_1024600", 60, 1024, 600, 17531, 120, 130, 15, 17, 70, 3,
        FB_SYNC_CLK_LAT_FALL,
        FB_VMODE_NONINTERLACED,
        FB_MODE_IS_STANDARD,},
	{
        /* 640*480 @ 60 Hz , pixel clk @ 25MHz */
        "TQ-VGA_640480", 60, 640, 480, 40000, 40, 8, 25, 2, 96, 2,
        FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
        FB_VMODE_NONINTERLACED,
        0,},
	{
	/* 1024*768 @ 70 Hz , pixel clk @ 75MHz */
	"TQ-VGA_1024768", 70, 1024, 768, 13346, 144, 24, 29, 3, 136, 6,
	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	FB_VMODE_NONINTERLACED,
	0,},
	{
        /* 1280*720 @ 60 Hz , pixel clk @ 74MHz */
        "TQ-VGA_1280720", 60, 1280, 720, 13513, 220, 110, 25, 3, 40, 2,
        FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
        FB_VMODE_NONINTERLACED,
        0,},	
	{
	/* 1280*768 @ 60 Hz , pixel clk @ 75MHz */
	"TQ-VGA_1280768", 60, 1280, 768, 14651, 80, 48, 12, 3, 32, 7,
	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	FB_VMODE_NONINTERLACED,
	0,},
	{
	/* 1360*768 @ 60 Hz , pixel clk @ 75MHz */
	"TQ-VGA_1360768", 60, 1360, 768, 11634, 256, 64, 18, 3, 122, 6,
	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	FB_VMODE_NONINTERLACED,
	0,},
	{
	/* 1920*1080 @ 60 Hz , pixel clk @ 75MHz */
	"TQ-VGA_19201080", 60, 1920, 1080, 7186, 84, 65, 20, 3, 12, 6,
	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	FB_VMODE_NONINTERLACED,
	0,},
	{
	/* 1920*1200 @ 54 Hz , pixel clk @ 75MHz */
	"TQ-VGA_19201200", 54, 1920, 1200, 7186, 80, 48, 26, 3, 32, 6,
	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	FB_VMODE_NONINTERLACED,
	0,},
	{
	"PANEL_LCD", 54, 1920, 1200, 7186, 80, 48, 26, 3, 32, 6,
	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	FB_VMODE_NONINTERLACED,
	0,},
};
	...
	struct mxc_dispdrv_setting *setting)
{
	...
	fb_replace_modedbs("lcd",&modedb[modedb_sz-1]);
